            ...
            <div class="row gy-4 gy-md-0">
                <div class="col-xs-12 col-md-7 order-1 order-md-0">
                    ...
                    <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
                        Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">Հեռախոսների
                            մասնագիտացված խանութ</a>
...
<script src="View/Public/js/Delete.js"></script>
<script src="View/Public/js/ChangeQuantity.js"></script>
